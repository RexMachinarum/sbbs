#ifndef SBBS_HEADER_GUARD
#define SBBS_HEADER_GUADER
...
extern int SBBS_outputDirectory(const char* const text);

/* shuts down all extra stuff that SBBS allocated itself */
extern void SBBS_cleanup();
